1. Нужно поднять на 2px текст "R&D Центр и лаборотория".

2. Скролл-анимация: сейчас сначала идёт скролл по странице, потом секция "садится" вверху и начинается появление карточек №2 и №3. А нужно, чтобы первичный скролл (с нуля) влиял только на секцию карточек, а уже по-завершению, начинался скролл по странице.
      ...
      <div className={cn(mobile ? "space-y-4" : "space-y-5")}>
        <div
          className={cn(
            ...
            mobile ? "text-[18px] leading-[1.08]" : "text-[20px] leading-[1.06]",
          )}
        >
          <div>R&amp;D Центр</div>
