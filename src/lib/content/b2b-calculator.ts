    ...
    options: [
      {
        value: "dealer",
        title: "Дилер",
        description: "Работаете через собственные продажи и клиентскую базу",
        icon: "users",
        score: {
          dealer_model: 3,
          ready_matrix: 1,
      ...
      },
      {
        value: "distributor",
        title: "Дистрибьютор",
        description: "Работаете с объёмами, географией и несколькими каналами",
        icon: "network",
        score: {
          hybrid_model: 3,
          dealer_model: 2,
      ...
      {
        value: "online_b2b",
        title: "B2B-ритейл / онлайн-канал",
        description: "Продаёте через онлайн-витрину или digital-канал",
        icon: "monitor",
        score: {
          ready_matrix: 2,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        value: "large",
        title: "Крупный объём",
        description: "Работаем на расширенный запуск и устойчивые поставки",
        icon: "warehouse",
        score: {
          private_label_model: 3,
          hybrid_model: 2,
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        description: "Нужна логистика и управляемая география отгрузок",
        icon: "route",
        score: {
          hybrid_model: 2,
          logistics: 3,
