...
export const heroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    metricBottom: "ТОНН",
    metricShellClassName: "w-[300px]",
    metricTopClassName: "text-[36px] leading-[0.9] tracking-[-0.06em]",
    metricBottomClassName: "text-[60px] leading-[0.88] tracking-[-0.08em]",
  ...
  },
  {
    ...
    metricShellClassName: "w-[300px]",
    metricTopClassName: "text-[64px] leading-[0.82] tracking-[-0.08em]",
    metricBottomClassName: "text-[28px] leading-[0.94] tracking-[-0.05em]",
    metricDividerClassName: "w-[260px] my-[12px]",
