...
export const heroSlides: HeroSlide[] = [
  ...
  },
  {
    ...
    metricBottomClassName: "relative -top-[2px] text-[64px] leading-[0.88] tracking-[-0.08em]",
  ...
  },
  {
    ...
    metricBottomClassName: "relative -top-[2px] text-[34px] leading-[0.94] tracking-[-0.05em]",
    metricDividerClassName: "w-[260px] my-[12px]",
